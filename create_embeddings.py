...
def generate_embeddings(texts, model_name='sentence-transformers/all-MiniLM-L6-v2'):
    ...
    embeddings = [embed_text(text, tokenizer, model, device).squeeze() for text in texts]
...
def main():
    ...
    json_file_path = 'app/data/markdown_files.json'
    ...
    with open('app/data/metadata.json', 'w', encoding='utf-8') as meta_file:
